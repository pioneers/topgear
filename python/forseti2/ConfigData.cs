...
namespace forseti2
{
    public sealed class ConfigData : LCM.LCM.LCMEncodable
    {
        ...
        {
            if (classes.Contains("forseti2.ConfigData"))
                return 0L;
 
            classes.Add("forseti2.ConfigData");
        ...
        public ConfigData(byte[] data) : this(new LCMDataInputStream(data))
        {
        }
 
        public ConfigData(LCMDataInputStream ins)
        {
        ...
        public static forseti2.ConfigData _decodeRecursiveFactory(LCMDataInputStream ins)
        {
